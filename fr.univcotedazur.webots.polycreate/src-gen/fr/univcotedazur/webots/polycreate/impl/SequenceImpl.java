 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.webots.polycreate.impl.SequenceImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceImpl extends MinimalEObjectImpl.Container implements Sequence {
	...
	protected EClass eStaticClass() {
		return PolycreatePackage.Literals.SEQUENCE;
	}
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, PolycreatePackage.SEQUENCE__ACTIONS);
		}
		return actions;
	}
