...
/**
 * This is the item provider adapter for a {@link fr.univcotedazur.webots.polycreate.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PolycreatePackage.Literals.SEQUENCE__ACTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case PolycreatePackage.SEQUENCE__ACTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.SEQUENCE__ACTIONS,
				PolycreateFactory.eINSTANCE.createMoveForward()));

		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.SEQUENCE__ACTIONS,
				PolycreateFactory.eINSTANCE.createRotateLeft()));

		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.SEQUENCE__ACTIONS,
				PolycreateFactory.eINSTANCE.createRotateRight()));

		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.SEQUENCE__ACTIONS,
				PolycreateFactory.eINSTANCE.createGrab()));
