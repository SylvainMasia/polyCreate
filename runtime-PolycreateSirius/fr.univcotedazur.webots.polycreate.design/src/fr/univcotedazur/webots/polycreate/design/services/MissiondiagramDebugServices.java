package fr.univcotedazur.webots.polycreate.design.services;
...
public class MissiondiagramDebugServices extends AbstractGemocDebuggerServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("Mission Diagram", "Debug"));
