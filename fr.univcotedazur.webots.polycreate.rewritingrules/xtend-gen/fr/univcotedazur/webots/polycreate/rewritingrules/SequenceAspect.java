...
public class SequenceAspect {
  @Step
  public static void runIt(final Sequence _self) {
    ...
    // #DispatchPointCut_before# void runIt()
    if (_self instanceof fr.univcotedazur.webots.polycreate.Sequence){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			fr.univcotedazur.webots.polycreate.rewritingrules.SequenceAspect._privk3_runIt(_self_, (fr.univcotedazur.webots.polycreate.Sequence)_self);
    		}
    	};
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.IStepManager stepManager = fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepManagerRegistry.getInstance().findStepManager(_self);
    	if (stepManager != null) {
    		stepManager.executeStep(_self, new Object[] {_self}, command, "Sequence", "runIt");
    	} else {
    		command.execute();
    	}
    	;
  ...
  protected static void _privk3_runIt(final SequenceAspectSequenceAspectProperties _self_, final Sequence _self) {
