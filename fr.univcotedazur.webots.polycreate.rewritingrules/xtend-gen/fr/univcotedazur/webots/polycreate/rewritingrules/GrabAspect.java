...
public class GrabAspect extends ActionAspect {
  @Step
  @ReplaceAspectMethod
  public static void runIt(final Grab _self, final PolyCreateControler controler, final SensorChecker logicalVerifications, final boolean isAlternative) {
    ...
    if (_self instanceof fr.univcotedazur.webots.polycreate.Grab){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			fr.univcotedazur.webots.polycreate.rewritingrules.GrabAspect._privk3_runIt(_self_, (fr.univcotedazur.webots.polycreate.Grab)_self,controler,logicalVerifications,isAlternative);
    		}
    	};
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.IStepManager stepManager = fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepManagerRegistry.getInstance().findStepManager(_self);
    	if (stepManager != null) {
    		stepManager.executeStep(_self, new Object[] {controler,logicalVerifications,isAlternative}, command, "Grab", "runIt");
    	} else {
    		command.execute();
    	}
    	;
  ...
  protected static void _privk3_runIt(final GrabAspectGrabAspectProperties _self_, final Grab _self, final PolyCreateControler controler, final SensorChecker logicalVerifications, final boolean isAlternative) {
